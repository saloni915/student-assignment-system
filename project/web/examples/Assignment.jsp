<%-- 
    Document   : Assignment
    Created on : Jan 12, 2019, 2:40:33 PM
    Author     : saloni
--%>
...
<body class="">
    ...
    <div class="main-panel">
      ...
      <div class="content" style="width:125%; margin-top:100px;margin-left:200px;">
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <div class="alert alert-info" style="background-color:cream;" >
                 
                  <form action='checkassignment.jsp'>
                      <br>
                      <font size="4px" color="white">
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <b>Year :</b>
                      <input type="text" name="year" STYLE="background-color:grey;color:white;" >
                      <br>
                      <br>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 
                      <b> Sem :</b>
                      <select  name="sem" STYLE="background-color:grey;color:white; width:250px; ">
