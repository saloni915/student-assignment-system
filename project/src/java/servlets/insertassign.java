 ...
 * @author Udit
 */
@WebServlet(name = "insertassign", urlPatterns = {"/insertassign"})
public class insertassign extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(adao.insertassign(week, ques, max_marks, expec, issue, due,assign_id))
                response.sendRedirect("./examples/subassign.jsp?sub_code="+sub_code);
        }
    }
