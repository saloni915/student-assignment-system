...
<body class="">
  ...
  <div class="wrapper">
    ...
    <div class="main-panel">
          ...
          <div class="rcorners1">
             ...
             <form action="../uploadassignment" id="question">
                 <h3 class="title d-inline"><font size="5pxs"color=" #ba6bfc ">SUBJECT:</font>
                        <input type="text" name="sub_name" value="<%=sub_name%>" STYLE="color: #0f0f0f;width:400px; background-color:#f3d4fc;font-weight: bold;text-align: center; " >
                 </h3><br><br><br>
                 <h3 class="title d-inline"><font size="4pxs"color=" #fdbd61 ">Week No:&nbsp;&nbsp;</font>
                     <input type="text" name="week_no" value="" STYLE="text-align: center;color: #0f0f0f;width:50px; background-color:#f3d4fc;font-weight: bold;" >
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <h3 class="title d-inline"><font size="4pxs"color="#fdbd61">Assignment No:&nbsp;&nbsp;</font> 
                  ...
                  <h3 class="title d-inline"><font size=4pxs"color="#ba6bfc">Due Date:&nbsp;</font>
                     <input type="date" name="duedate" value="" STYLE="text-align: center;color: #0f0f0f;width:250px; background-color:#f3d4fc;font-weight: bold;" >&nbsp;&nbsp;&nbsp;
                  </h3><br><br><br>
                  <h3 class="title d-inline"><font size="4pxs"color="   #b7ff42  ">Issue Date:&nbsp;</font>
                        <input type="date" name="issuedate" value="<%=java.time.LocalDate.now()%>" STYLE="text-align: center;color: #0f0f0f;width:250px; background-color:#f3d4fc;font-weight: bold;" >
                  </h3><br><br><br>
                  
                  <h3 class="title d-inline"><font size="4pxs"color=" #ba6bfc  ">Max_Marks:&nbsp;&nbsp;</font>
                  ...
                  <div class="rcorners3">
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <h3 class="title d-inline"><font size="4pxs"color="  #ba6bfc  ">Sub Code:&nbsp;&nbsp;</font>
                  ...
                  <h3 class="title d-inline">
                       <br><br>
                        ...
                        <font size="4pxs">
                        <textarea rows="6" cols="60" name="ques" form="question"  style="background-color:black; color:whitesmoke;"  ></textarea><br><br></font>
                         
                     
                        <font size="5pxs"color="  #55aefd  ">Expected Solution:</font> <br>
                        <div class="myBox">
                        <textarea rows="100" cols="70" name="expecsol" form="question" style="background-color:black;color:whitesmoke;"></textarea></div>
                  </h3>    
                      <br>
                      <h3>
                      <input type="submit" value="Add" name="res"  style=" height:40px;float:left; " >
                      <input type="submit" value="Upload" name="res" style="height:40px;float: right; " >
                     </h3>
      ...
      <footer class="footer" style="margin-top:1300px;margin-right:100px;">
