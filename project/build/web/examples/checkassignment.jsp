<%-- 
    ...
    Created on : Nov 27, 2018, 2:03:12 PM
    Author     : Udit
--%>
  ...
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <div class="modal modal-search fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModal" aria-hidden="true">
       ...
       <div class="card-body" style="margin-left:450px;margin-top:80px;">
        <form>
                    <font size="4px" color="cyan">
                        <b>Year :</b>
                        <% 
                           ...
                           String sem=request.getParameter("sem");
                            out.print("<input type='text' name='year' STYLE='background-color: lightcyan;color:black; text-align: center' disabled value='" + year+ "'" );
                            session.removeAttribute("sub_name");
                            session.removeAttribute("sub_code");
                            %>
                        
                            <br>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <b> Sem :</b>
                     <input type="text" name="sem" value="<%out.print(sem);%>"  STYLE="background-color: lightcyan;color:black; text-align: center;"  disabled >
                     </font>            
        </form>
            ...
            response.sendRedirect("../index_login.html");
                    ...
                    // out.println(session.getAttribute("loginid"));
                     ...
                     ArrayList<subject> sub =dao.getsub(year,loginid.intValue(),sem);
                    /* for(int i=0;i<sub.size();++i){
                         out.println(sub.get(i).getName());
                     }*/
           ...
           out.print(" <div class='card card-chart' >");
            ...
            out.print("    <div class='row'>");
             ...
             out.print("      <h5 class='card-category'><font color='white'> <b> SEMESTER: </b>");
                     ...
                     out.print("</div></font>");
                     out.print("</h5>");
            out.print( "       <h1 style='color:whitesmoke; text-align:center; margin-left:90px; margin-top:10px;'><b> ");
            ...
            if(sub.get(i).getName().length()<=19)
                          out.print("<br><br>"); 
            out.print(" <form action='studentrecords.jsp' > <input type='text' name='sub_name' hidden value='"+sub.get(i).getName()+"'> <input type='text' name='year' hidden value='"+year+"'> "
